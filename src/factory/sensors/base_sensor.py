...
class SensorConfig:
    ...
    qos: int # Kept for config compatibility, but no longer used
...
class IndustrialSensor:
    ...
    def generate_payload(self):
        base = {"timestamp": datetime.utcnow().isoformat(), "line_id": self.line_id, "sensor_id": self.sensor_id, "type": self.config.sensor_type}
